...
#define LOG_TRACE     BOOST_LOG_STREAM_SEV(lg::getLogRef(), lg::Trace) \
        << __FUNCTION__ << ":" << __LINE__ << "(): "

#define LOG_DEBUG     BOOST_LOG_STREAM_SEV(lg::getLogRef(), lg::Debug) \
        << __FUNCTION__ << ":" << __LINE__ << "(): "

#define LOG_INFO      BOOST_LOG_STREAM_SEV(lg::getLogRef(), lg::Info) \
        << __FUNCTION__ << ":" << __LINE__ << "(): "

#define LOG_WARNING   BOOST_LOG_STREAM_SEV(lg::getLogRef(), lg::Warning) \
        << __FUNCTION__ << ":" << __LINE__ << "(): "

#define LOG_ERROR     BOOST_LOG_STREAM_SEV(lg::getLogRef(), lg::Error) \
        << __FUNCTION__ << ":" << __LINE__ << "(): "

#define LOG_FATAL     BOOST_LOG_STREAM_SEV(lg::getLogRef(), lg::Fatal) \
        << __FUNCTION__ << ":" << __LINE__ << "(): "
